...
/**
 * @ORM\Entity(repositoryClass=AccountsPaymentTypeRepository::class)
 */
class AccountsPaymentType
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\OneToMany(targetEntity=Student::class, mappedBy="accountsPaymentType")
     */
    private $students;
    ...
    public function addStudent(Student $student): self
    {
        if (!$this->students->contains($student)) {
            ...
            $student->setAccountsPaymentType($this);
        }
    ...
    public function removeStudent(Student $student): self
    {
        if ($this->students->removeElement($student)) {
            ...
            if ($student->getAccountsPaymentType() === $this) {
                $student->setAccountsPaymentType(null);
            }
        }
    ...
    public function __remove($name, $value): self
    {
        if ($this->$name->removeElement($value)) {
            // set the owning side to null (unless already changed)
            if ($value->getAccountsPaymentType() === $this) {
                $value->setAccountsPaymentType(null);
            }
        }
